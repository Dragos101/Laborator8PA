...
public class Directoridoa {
    public Connection connection;

    Directoridoa() throws ClassNotFoundException, SQLException {
    ...
    public void create(String nume, String prenume) throws SQLException {
        String sql = "INSERT INTO DIRECTOR(NUME, PRENUME) VALUES(?, ?)";
    ...
    public void findByNume(String nume) throws SQLException {
        ...
        ResultSet rezultat = comanda.executeQuery("Select NUME, PRENUME from DIRECTOR where NUME like '" + nume+"'");
        while (rezultat.next())
    ...
    public void findByPrenume(String prenume) throws  SQLException{
        Statement comanda = connection.createStatement();
        ResultSet rezultat = comanda.executeQuery("Select NUME, PRENUME from DIRECTOR where PRENUME like '" + prenume +"'");
        while (rezultat.next())
            System.out.println(rezultat.getString(1) + "  " + rezultat.getString(2));
    }
}
